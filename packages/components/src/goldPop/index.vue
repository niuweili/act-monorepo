<template>
    <van-popup v-model:show="show" position="bottom" teleport="#app" @close="closed">
        <div class="gold_pop">
...
import { toDecimal, isIOS } from '@/utils/tool';
...
.gold_pop {
    height: 300px;
    width: 100vw;
    background: url('http://res-static.inframe.mobi/ui/1691830925857bd.png') no-repeat 100% / 100%;
    padding-top: 40px;
    .title {
        font-weight: 500;
        font-size: 18px;
